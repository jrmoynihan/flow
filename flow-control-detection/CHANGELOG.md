...
### New Features
 ...
 - <csr-id-fb577089761552854373d4342ea842e3afb2b3ba/> improve single-stain and fluorophore parsing
   Normalize filenames more aggressively and match known fluorophore tokens so
   reference/single-stain controls classify more reliably from instrument names.
 ...
 * **Uncategorized**
    ...
    - Improve single-stain and fluorophore parsing ([`fb57708`](https://github.com/jrmoynihan/flow/commit/fb577089761552854373d4342ea842e3afb2b3ba))
