...
fn main() -> io::Result<()> {
    ...
    let f32_par_inline = results_100k
        .iter()
        .find(|(n, _)| n.contains("uniform_f32_parallel_inline"));
    let f32_par_no = results_100k
        .iter()
        .find(|(n, _)| n.contains("uniform_f32_parallel_no_hints"));
    ...
    let f32_seq_inline = results_100k
        .iter()
        .find(|(n, _)| n.contains("uniform_f32_sequential_inline"));
    let f32_seq_no = results_100k
        .iter()
        .find(|(n, _)| n.contains("uniform_f32_sequential_no_hints"));
    ...
    let i16_par_inline = results_100k
        .iter()
        .find(|(n, _)| n.contains("uniform_i16_parallel_inline"));
    let i16_par_no = results_100k
        .iter()
        .find(|(n, _)| n.contains("uniform_i16_parallel_no_hints"));
    ...
    let i16_seq_inline = results_100k
        .iter()
        .find(|(n, _)| n.contains("uniform_i16_sequential_inline"));
    let i16_seq_no = results_100k
        .iter()
        .find(|(n, _)| n.contains("uniform_i16_sequential_no_hints"));
    ...
    let var_cold = results_100k
        .iter()
        .find(|(n, _)| n.contains("variable_width_sequential_cold"));
    let var_no = results_100k
        .iter()
        .find(|(n, _)| n.contains("variable_width_sequential_no_hints"));
